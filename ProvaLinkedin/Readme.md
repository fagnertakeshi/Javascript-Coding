Javascript Test for Linkedin
 
#### Q1 - What is the difference between the map() and the forEach() methods on the Array prototype?

a) ( ) There is no difference.
b) ( ) The forEach() method returns a single output value, whereas the map() method performs operations on each value in the array.
c) ( ) The forEach() method returns a new array with a transformation applied to each item in the original array, whereas the map() method
iterates through an array with no return value.
d) ( ) The map() method returns a new array with a transformation applied on each item in the original array, whereas the
forEach() method iterates through an array with no return value.

#### Q2 - How do you remove the property name from this object?
```js
const foo = {
name: "Albert"
};
...
#### Q3 - Which statement creates a new function called discountPrice?

a) ( ) let function = discountPrice(price) {
return price * 0.85;
}
...
d) let discountPrice = function(price) {
return price* 0.85;
};

#### Q3 - What will this code log to the console?
 const foo = [1,2,3];
 const [n] = foo;
 console.log(n);
...
#### Q5 - What statement can be used to skip an iteration in a loop?
...
#### Q6 - Which property references the DOM object that dispatched an event?
...
#### Q7 - What type of scope does the end variable have in this code?
...
#### Q8 - Which variable-defining keyword allow its variable to be accessed ( as undefined) before the line that defines it?
...
b)The output may change with each execution of the code and cannot be determined.
...
c)I
 ...
 #### Q10 - What will this code log to the console?
...
#### Q13 - Which Javascript loop ensures that at least a singular iteration will happen?
...
#### Q14 - This program has a problem. What is it?
...
#### Q15 - Wich statement can take a single expression as input, and then look through a number of choices until one that
matches tjat value is found?
...
#### Q16 - How do you remove the property name from this object?
...
#### Q17 - Which choice is a valid variable name?
...
#### Q18 - Which method call is chained to handle a successful response returned by fetch()?
...
#### Q19 - Which statement is true about objects and functions in JavaScript?

a) A function always returns an object.

b) Every object is a function

c) Every function is an object.


#### Q20 - What is wrong with this line of code?

let result= if ( 3=='3') {42} else {0};

a) The if keyword starts a statement, not an expression.
...
#### Q21 - Which choice is a valid example of an arrow function, assuming  c is defined in the outer scope?
...
#### Q22 - How do you add a comment to Javascript code?
...
#### Q23 - What two values will this code print?
...
24 - Which expression evaluates to true?
...
#### Q25 - Which choice is not a keyword in JavaScript?
...
#### Q26- Which variable-defining keyword behaves differently in function scopes than it does in block scopes
